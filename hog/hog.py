...
def roll_dice(num_rolls, dice=six_sided):
    ...
    return 1 if hit_1 is True else sum
...
def swine_align(player_score, opponent_score):
    ...
    # if the GCD for player_score and
    # opponent_score is greater than 10
    ...
    return True if player_score >= 10 else False
...
def pig_pass(player_score, opponent_score):
    ...
    return player_score < opponent_score and abs(player_score - opponent_score) < 3
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (max(score0,score1) < goal):
        ...
        # player 1's turn
            ...
            while extra_turn(score0, score1) is True and score0 < goal:
                score0 += take_turn(strategy0(score0, score1), score1, dice)
                say = say(score0, score1)
            who = 1
        ...
        # player 2's turn
            ...
            say = say(score0, score1)
            while extra_turn(score1, score0) is True and score1 < goal:
                score1 += take_turn(strategy1(score1, score0), score0, dice)
                say = say(score0, score1)
            who = 0
    ...
    def say(score0, score1):
        ...
        if who == 0:
            if score0 > last_score:
                last = abs(last_score - score0)
                if last > running:
                    print(last, "point(s)! The most yet for Player", who)
                    running = last
        else:
            if score1 > last_score:
                last = abs(last_score - score1)
                if last > running:
                    print(last, "point(s)! The most yet for Player", who)
                    running = last

        if who == 1 : return announce_highest(who,score1 ,running)
        if who == 0 : return announce_highest(who,score0 ,running)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    result = 1
    av = make_averaged(roll_dice, trials_count)
    av_result = av(result,dice)
    i = 2
    while i < 11:
        av_test = av(i,dice)
        if av_test > av_result:
            result = i
            av_result = av_test
        i += 1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    st = bacon_strategy(score, opponent_score, cutoff, num_rolls)
    return 0 if not st or extra_turn(score + free_bacon(opponent_score) , opponent_score) else num_rolls
    # END PROBLEM 11
