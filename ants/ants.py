...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while temp_place != beehive:
            if self.min_range <= distance <= self.max_range and temp_place.bees:
    ...
    def reduce_armor(self, amount):
        ...
        for b in lis:
            if self.armor - amount <= 0:
                b.reduce_armor(amount + self.damage)
            else:
...
class HungryAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        if self.digesting <= 0 and  bee != None:
            self.eat_bee(bee)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        ...
        self.true_queen = QueenAnt.queen_number
        # END Problem EC
        ...
        if self.true_queen != 1:
            ...
            while cur_place != None:
                if  cur_place.ant and not cur_place.ant.doubled:
                    cur_place.ant.damage = 2 * cur_place.ant.damage
...
# END Problem EC
    ...
    def reduce_armor(self, amount):
        ...
        """
        # BEGIN Problem EC
        if self.armor - amount <= 0 and self.true_queen == 1:
